...
public class Game {
  ...
  private static String introText = "Welcome to Freep!";
  private static String endingText = "The end...";
  private static String roomText = "There is a cave opening to the North. On the floor there is scattering of papers. You are surrounded by a redwood forest on all other sides.";
